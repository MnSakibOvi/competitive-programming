    ...
    if(x==o || x==o+1)
       {
        ...
        if(flx==0 && flo==0)
        cout<<"yes"<<endl;
        else if(flx==1 && flo==0 && x==o+1)
            cout<<"yes"<<endl;
       else if(flx==0 && flo==1 && x==o)
            cout<<"yes"<<endl;
        else if(flx==2 && flo==0 && x==5 && o==4)
